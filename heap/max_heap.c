//Program to implement a max heap using linked lists
#include<stdio.h>
#include<stdlib.h>
...
//function to print the max heap in in-order
...
//function to print the max heap in pre order 
...
//function to print the max heap in post order
